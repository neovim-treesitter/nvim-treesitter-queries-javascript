...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-javascript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-javascript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **javascript**, part of the
...
- [ ] Changes are scoped to `javascript` — do not include files for other languages
